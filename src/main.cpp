...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("NotepadNextDev");
    QApplication::setApplicationName("NotepadNextDev");
    QGuiApplication::setApplicationDisplayName("Notepad Next Dev");
